    ...
    def forward(
        ...
        with utils.LocallyOverridenDefaults(
            ...
            if stop_at_layer is not None:
                ...
                elif return_type == "gererate_with_saev":
                    image_indices = []
                    for indice,token in enumerate(tokens[0]):
                        if token.item()==8711:
                            image_indices.append(indice)

                    return residual, image_indices
            ...
            if return_type is None:
                ...
                with open("./img_token_list.txt", "r") as f:
                    data = f.read()
